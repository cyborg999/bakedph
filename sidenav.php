				...
				<div class="card">
				    ...
				    <div id="collapseMaterials" class="<?= ($active == "material") ? "show" : ""; ?> collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
				      <div class="card-body">
						  ...
						  <li class="list-group-item">
						  	<?php
          						$allMaterials = $model->getAllPurchase();
						  	?>
						  	<a href="all_materials.php" class="black">All Materials <span class="badge badge-primary badge-pill"><?= count($allMaterials) ?></span></a>
						  </li>
						   <li class="list-group-item">
						  	<?php
