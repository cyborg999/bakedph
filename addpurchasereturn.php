	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-10">
				...
				<div class="col-sm">
				  	<?php
			          $purchaseMaterials = $model->getStorePurchaseReturn();
			        ?>
			        <div class="row">
					...
					<div class="row">
						<div class="col-sm-4">
							<h5>Purchase Return Information</h5>
							<form method="post" class="form">
								<input type="hidden" name="addSalesReturn" value="true">
								<div class="form-group">
									<label>Material</label>
									<select id="product" class="form-control">
										<?php foreach($purchaseMaterials as $idx => $s): ?>
											<option value="<?= $s['materialid'];?>"><?= $s['name'];?></option>
										<?php endforeach ?>
									</select>
								</div>
								<div class="form-group">
    		...
    		$(document).ready(function(){
    			...
    			$(".submit").on("click", function(e){
    				...
    				if(tr.length){
    					$.ajax({
							url : "ajax.php"
							, data : { addPurchaseReturn : true , data : data}
							, type : 'post'
							, dataType : 'json'
